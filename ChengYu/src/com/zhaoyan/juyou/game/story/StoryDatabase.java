...
public class StoryDatabase {
	...
	public void createTables() throws SQLException {
		...
		statement.execute("drop table if exists " + StoryItemTable.HISTORY_TABLE_NAME);
		statement.execute(StoryItemTable.createTable(StoryItemTable.HISTORY_TABLE_NAME));
	...
	public static class StoryItemTable implements BaseColumns {
		...
		public static final String createTable(String tablename) {
			return "create table " + tablename
					+ " ( _id INTEGER PRIMARY KEY AUTOINCREMENT, " + TYPE
					+ " INTEGER, " + TITLE + " TEXT, " + FILENAME + " TEXT, " + SIZE + " LONG);";
		}
	}
