...
public class DownloadAppData {
	...
	public static final String AUTHORITY = "com.zhaoyan.juyou.provider.ZyProvider";

	/**
	 * table download app
	 */
	public static final class DownloadApp implements BaseColumns {
		public static final String TABLE_NAME = "dlapp";
		public static final Uri CONTENT_URI = Uri.parse("content://"
				+ AUTHORITY + "/dlapp");
		public static final Uri CONTENT_FILTER_URI = Uri.parse("content://"
				+ AUTHORITY + "/dlapp_filter");
		public static final String CONTENT_TYPE = "vnd.android.cursor.dir/dlapp";
		public static final String CONTENT_TYPE_ITEM = "vnd.android.cursor.item/dlapp";
